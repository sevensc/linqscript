...
var checklist = function (enumeration: any[]) {
    return enumeration[0] === "red" && enumeration[1] === "yellow" && enumeration[2] === "blue";
};
...
describe("List.Where()", () => {
    it("should return true if values where correctly selected", () => {
        ...
        var expected = false;
        if (actual.length === 2 && actual[0].Name === "Banana" && actual[0].Color === Color.Yellow)
            expected = true;
...
describe("ToArray()", () => {
    it("should return true if list converted to Array", () => {
        ...
        console.log("Result: " + JSON.stringify(`type of ${Object.prototype.toString.call(array)}`));
...
describe("Select()", () => {
    it("should return true if only colors selected", () => {
        ...
        var expected = false;
        if (actual.length === 3 && actual[0] === Color.Red &&
            actual[1] === Color.Yellow && actual[2] === Color.Blue)
            expected = true;
...
describe("Remove()", () => {
    ...
    var actual = false;
    if (fruits.length === 2 && fruits[0].Name === "Apple" && fruits[1].Name === "Grape")
        actual = true;
...
describe("Distinct", () => {
    it("should return true", () => {
        ...
        if (actual.length === 3 && actual[0].Name == "Apple" && actual[1].Name == "Banana" && actual[2].Name == "Lemon")
            expected = true;
    ...
    it("should return true if distinct works on delegate by select distinct value", () => {
        ...
        var expected = false;
        if (actual.length === 2 && actual[0] === Color.Red && actual[1] === Color.Yellow)
            expected = true;
